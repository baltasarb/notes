...
import semiLockFreeSynchronization.optimizedMessageQueue.MessageStatus;
import semiLockFreeSynchronization.optimizedMessageQueue.OMessageQueue;
...
public class OMessageQueueTests {
    ...
    public void sendBeforeReceiveTest() throws InterruptedException {
        ...
        OMessageQueue<String> messageQueue = new OMessageQueue<>();
    ...
    public void moreProducersThanConsumers() throws InterruptedException {
        ...
        OMessageQueue<Integer> messageQueue = new OMessageQueue<>();
